...
├── script.js         (JavaScript - Lógica interactiva)
...
- Edición de descripción de proyectos
...
| Función | Descripción |
|---------|------------|
| `filterProjects()` | Filtra proyectos por categoría |
| `toggleProjectDetails()` | Muestra/oculta tecnologías |
...
- `classList.add/remove()` - Controlar clases
- `textContent` - Cambiar texto
- `style.display` - Modificar estilos
...
✔️ Selectores CSS  
✔️ Métodos de DOM  
✔️ Iteración con forEach  
✔️ Arrays y objetos  
✔️ Funciones modularizadas  
✔️ Condicionales  
✔️ Atributos personalizados (data-*)  

---

**Proyecto completado:** Abril 14, 2026  
**Estudiante:** Juan David  
**Asignatura:** Desarrollo Web - Manipulación del DOM  
